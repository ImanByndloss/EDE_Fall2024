...
# month.abb is a known variable: "Jan" "Feb" "Mar" "Apr" "May" "Jun" "Jul" "Aug" "Sep" "Oct" "Nov" "Dec"
...
# color=... instead aes() to color code plot based on variable; outside of aes() color=... simply changes the color of a particular layer
...
EPAair %>%
  ggplot(aes(x=factor(Year), y=PM2.5, color=factor(Year)), alpha=0.5) +
  geom_boxplot() +
  labs(x="Year",color="Year")
