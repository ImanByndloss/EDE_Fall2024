...
#Reveal the column names
colnames(huc8_sf)
# glimpse() also shows the structure of the dataset

#Check the CRS
st_crs(huc8_sf)$epsg
# only reports epsg value which you can paste into epsg.io for more information or just used st_crs() with no specification for more information

#View the data as a map, colored by the acreage in each
mapView(huc8_sf, col.regions="ACRES")
