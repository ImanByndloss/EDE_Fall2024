...
> Answer: In my opinion, plot 7 (with facets instead of colors) is more effective due to the number of points on the graph when the NLCD classes are plotted on one graph. With such a high number of points, plot 6 appears crowded (especially below 10 for dry mass where most of the points are concentrated). Such a depiction makes plot 6 more difficult to analyze and compare the data for each class.