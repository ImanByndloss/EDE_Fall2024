...
# Use ggplot() to create a line graph that compares Durham and Asheville
ggplot(Asheville2018to2022, aes(x = Month, y = MGD, 
...
> Answer:
> Generally, according to the trend line, water usage in Asheville peaks in the summer months between June and August and valleys in the winter between January and March. Still, from year to year, there is variation, particularly for the extent of usage, but almost all records for maximum daily use are in the 20s.
