...
rain_ts <- ts(BR_complete$Rainfall, start = c(1901,1), frequency = 12)
...
rain_decomposed <- stl(rain_ts, s.window = "periodic")
temp_decomposed <- stl(temp_ts, s.window = "periodic")
plot(rain_decomposed)
plot(temp_decomposed)

#larger bar besider graph means less influence on data



# Exercise 9: Use the times series object generated with the stl() to extract the 
# components of each series and turn them into data frames, required to plot with ggplot
...
rain_components <- mutate(rain_components,
